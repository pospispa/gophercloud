...
func (client *ServiceClient) setMicroversionHeader(opts *RequestOpts) {
	switch client.Type {
	case "compute":
		opts.MoreHeaders["X-OpenStack-Nova-API-Version"] = client.GetMicroversion()
	case "sharev2":
		opts.MoreHeaders["X-OpenStack-Manila-API-Version"] = client.GetMicroversion()
	}

	if client.Type != "" {
		opts.MoreHeaders["OpenStack-API-Version"] = client.Type + " " + client.GetMicroversion()
	}
}
